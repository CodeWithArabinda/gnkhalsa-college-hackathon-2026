  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.3, 0.75)}>
      <Tilt
        ...
        glareColor="#aaa6c3"
      >
        <div className="bg-tertiary w-full rounded-2xl p-5 sm:w-[350px] border border-white/5 hover:border-[#915EFF]/40 transition-all">
            ...
            <div className="card-img_hover absolute inset-0 m-3 flex justify-end gap-2">
              {liveLink && (
                <div
                  ...
                  title="Live Demo"
                  className="black-gradient flex h-9 w-9 cursor-pointer items-center justify-center rounded-full hover:scale-110 transition-transform"
                >
