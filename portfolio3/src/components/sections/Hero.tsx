...
const Hero = () => {
  return (
    <section className={`relative mx-auto h-screen w-full flex flex-col justify-between overflow-hidden`}>
      <div
        className={`absolute inset-0 top-[100px] sm:top-[120px] mx-auto max-w-7xl ${styles.paddingX} flex flex-col sm:flex-row items-start gap-6 z-10 pointer-events-none`}
      >
        <div className="flex flex-row sm:flex-col items-center justify-center gap-2 sm:mt-5">
          <div className="h-5 w-5 rounded-full bg-[#915EFF] shadow-[0_0_15px_#915EFF]" />
          <div className="violet-gradient h-1 w-20 sm:w-1 sm:h-64" />
        </div>
      ...
      <div className="absolute bottom-6 sm:bottom-10 flex w-full items-center justify-center z-10 pointer-events-auto">
        <a href="#about">
