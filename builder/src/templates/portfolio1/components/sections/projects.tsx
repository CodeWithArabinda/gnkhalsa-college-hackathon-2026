...
import { Project } from "@portfolio1/data/projects";
    ...
    <div className="flex items-center justify-center">
      <ResponsiveDialog>
        <ResponsiveDialogTrigger className="bg-transparent flex justify-center w-full">
          <div
            className="group relative w-full max-w-[400px] h-auto rounded-2xl overflow-hidden surface-card hover:-translate-y-1.5"
          ...
          >
            ...
            />
            <div className="absolute w-full h-28 bottom-0 left-0 bg-gradient-to-t from-slate-950 via-slate-950/90 to-transparent pointer-events-none z-10">
              <div className="flex flex-col h-full items-start justify-end p-4">
                <div className="text-lg font-bold text-white text-left tracking-tight group-hover:text-emerald-400 transition-colors">
                  {project.title}
                </div>
                <div className="text-[11px] font-mono font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full px-2.5 py-0.5 mt-1">
                  {project.category}
                </div>
              </div>
            </div>
