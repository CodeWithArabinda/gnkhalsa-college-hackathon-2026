          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {items.map((item, pIdx) => {
              ...
              return renderItem(`project-item-${pIdx}`, `Project Card ${pIdx + 1}`, (
                <div className="bg-white border-3 border-black rounded-2xl p-5 space-y-4 shadow-[5px_5px_0px_#000]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((item, pIdx) => {
            return renderItem(`project-item-${pIdx}`, `Showcase Card ${pIdx + 1}`, (
              <div key={item.id || pIdx} className="bg-white border border-slate-200 rounded-3xl p-6 space-y-4 shadow-xs flex flex-col justify-between">
