...
const Portfolio1Template = lazy(() => import('../../templates/templates/Portfolio1Template'));
const Portfolio2Template = lazy(() => import('../../templates/templates/Portfolio2Template'));
const Portfolio3Template = lazy(() => import('../../templates/templates/Portfolio3Template'));
const Portfolio4Template = lazy(() => import('../../templates/templates/Portfolio4Template'));
const Portfolio5Template = lazy(() => import('../../templates/templates/Portfolio5Template'));
